          ...
          <div class="col-lg-8 p1-lg-0">
            <div class="card card-details">
               ...
               <table class="table table-responsive-sm text-center">
                 ...
                 <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-middle">
                        <a href="{{route('checkout-remove',['id' =>$detail->id]) }}">
             ...
             <div class="member mt-3">
               ...
               action="{{route('checkout-create', ['id' => $item->id])}}">
               @csrf
               ...
               <p class="disclaimer mb-0">
                You are only able to invite member that has registered in Travel.
               </p>
              </div>
             </div>
            </div>
                ...
                <p class="payment-instruction">Please complete your payment before to
                  ...
                  <div class="bank">
                    <div class="bank-item pb-3">
                      <img src="{{url('frontend/img/ic_bank.png')}}" class="bank-image" alt="">

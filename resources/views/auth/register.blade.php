            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{'frontend/img/logo-travel.png'}}" alt="" class="w-50">
                    </div>
                     <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        ...
                        <p class="text-center mt-2 ">
                            <a class="btn btn-link" style="color: black; opacity : 0.8; text-decoration:none" href="{{ route('login') }}">
                                {{ __('have an account, please login') }}
                            </a>
                        </p>
                    </form>
                </div>
